...
describe('Contato Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'contato', component: ContatoComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to contatoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getContatoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getContatoIdentifier).toHaveBeenCalledWith(entity);
