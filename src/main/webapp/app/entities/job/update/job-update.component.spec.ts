...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 16939 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 23629 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 15606 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 16747 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 13950 };
      job.tasks = [task];
      const employee: IEmployee = { id: 24519 };
      job.employee = employee;
