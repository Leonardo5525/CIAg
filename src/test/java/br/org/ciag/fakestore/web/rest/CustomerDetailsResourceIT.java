...
import br.org.ciag.fakestore.domain.enumeration.Gender;
import br.org.ciag.fakestore.repository.CustomerDetailsRepository;
import br.org.ciag.fakestore.service.CustomerDetailsService;
...
class CustomerDetailsResourceIT {
    ...
    void partialUpdateCustomerDetailsWithPatch() throws Exception {
        ...
        partialUpdatedCustomerDetails.addressLine2(UPDATED_ADDRESS_LINE_2);
