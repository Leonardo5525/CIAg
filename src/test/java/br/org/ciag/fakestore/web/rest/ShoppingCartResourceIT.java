...
import br.org.ciag.fakestore.domain.CustomerDetails;
import br.org.ciag.fakestore.domain.ShoppingCart;
import br.org.ciag.fakestore.domain.enumeration.OrderStatus;
import br.org.ciag.fakestore.domain.enumeration.PaymentMethod;
import br.org.ciag.fakestore.repository.ShoppingCartRepository;
...
class ShoppingCartResourceIT {
    ...
    void partialUpdateShoppingCartWithPatch() throws Exception {
        ...
        partialUpdatedShoppingCart.placedDate(UPDATED_PLACED_DATE).totalPrice(UPDATED_TOTAL_PRICE).paymentMethod(UPDATED_PAYMENT_METHOD);
