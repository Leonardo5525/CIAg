...
describe('Produtos Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'produtos', component: ProdutosComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to produtosService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getProdutosIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProdutosIdentifier).toHaveBeenCalledWith(entity);
