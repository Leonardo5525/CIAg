...
import br.org.ciag.fakestore.domain.ProductOrder;
import br.org.ciag.fakestore.repository.ProductOrderRepository;
import br.org.ciag.fakestore.service.ProductOrderService;
...
/**
 * REST controller for managing {@link br.org.ciag.fakestore.domain.ProductOrder}.
 */
@RestController
...
public class ProductOrderResource {
     ...
     */
    @GetMapping("")
    public List<ProductOrder> getAllProductOrders(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
