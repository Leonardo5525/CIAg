...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 24997 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 2024 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 12744 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 29878 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 24725 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 18692 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 762 };
      jobHistory.job = job;
      const department: IDepartment = { id: 13208 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 27390 };
      jobHistory.employee = employee;
