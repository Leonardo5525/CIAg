...
import contatoResolve from './contato-routing-resolve.service';

describe('Contato routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: ContatoService;
  let resultContato: IContato | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IContato returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        contatoResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultContato).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IContato>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
